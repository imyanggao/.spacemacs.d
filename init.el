...
values."
  ...
  (setq-default
   ...
   ;; (default "M-m")
   dotspacemacs-emacs-leader-key "<escape>"
...
`dotspacemacs/user-config' first."
  ...
  ;; ;; manually set since (/ (x-display-pixel-height) (frame-char-height)) not work
